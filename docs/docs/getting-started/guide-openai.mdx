...
```shell
go run github.com/manslaughter03/langchaingo/examples/openai-completion-example@main
```
...
Here is the entire program (from [openai-completion-example](https://github.com/manslaughter03/langchaingo/blob/main/examples/openai-completion-example/openai_completion_example.go)).
