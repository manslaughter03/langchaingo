...
```shell
go run github.com/manslaughter03/langchaingo/examples/mistral-completion-example@main
```
...
Here is the entire program (from [mistral-chat-example](https://github.com/manslaughter03/langchaingo/blob/main/examples/mistral-chat-example/mistral_chat_example.go)).
